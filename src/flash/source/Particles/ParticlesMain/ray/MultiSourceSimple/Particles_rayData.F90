...
! default value for outflow boundaries
  ...
  integer,parameter :: ph_numIntProp = 5, ph_numRealProp = 11, ph_numProp = 16
...
! ray properties, 4, integer
  integer, save:: ihlev, istpd, isid
...
! indices into transport buffers 
  integer, save :: itnion, ithnum, itinfo, itrad, itid, itblk
