...
subroutine Particles_computeDt (blockID, dt_part, dt_minloc)
  ...
  use Particles_sinkData, ONLY : min_wind_dt ! Return the smallest wind timestep on the grid. - JW
...
!!! All commented out since we don't integrate particles here. -JW

dt_part = min_wind_dt !1e99  ! Ridiculously large so that hydro is always smaller. - JW
