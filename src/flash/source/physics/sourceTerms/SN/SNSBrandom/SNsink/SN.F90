...
!		 he_r_exp_max, he_SNmapToGrid
  use mtmod
	...
	use SB_data, Only: useSB, sb_nSN, sbPOS, sb_useSNsink, sn_outflowFrac, &
					   sn_SFDelay, sb_life, sn_sinkBulkMotion, sn_cloudMassPerStar
...
!/////////////////////////////////////////////////////////
    ...
    do i = 1, localnp
		...
		cluster_age = time - particles_global(CREATION_TIME_PART_PROP, i) - sn_SFDelay
...
! JC - Check if sink should be turned off
	...
	print*,'Turning off sink',i 
        ...
        tstar1 = nsn1*particles_global(TSN_PART_PROP,i) + particles_global(TCRT_PART_PROP, i) + sn_SFDelay
