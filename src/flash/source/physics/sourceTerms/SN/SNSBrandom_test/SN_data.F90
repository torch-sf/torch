...
#include "constants.h"
  ...
  !SN number 
  integer, save		::  he_nsndt, he_nSN, he_nms, sn_callRNG
  ...
  real, save		:: sn_MCTracerShellDis, sn_MCTracerMaxRad
...
!  switches for different physics, super-novae, -bubbles and stellar winds, stratification and subcycling 
  ...
  logical,save	:: he_useSN, he_useSNrandom, he_veltracer
...
! for log file 
  ...
  character (len=MAX_STRING_LENGTH), save :: he_outputDir
