...
MPI_PATH   = /mpcdf/soft/SLE_15/packages/skylake/openmpi/gcc_13-13.1.0/4.1.8
HDF4_PATH  =
HDF5_PATH  = /mpcdf/soft/SLE_15/packages/skylake/hdf5/gcc_13-13.1.0/1.14.1
HYPRE_PATH = /usr/local/hypre

HDF5INCLUDE   = ${HDF5_PATH}/include
HDF5LIBPATH   = ${HDF5_PATH}/lib
