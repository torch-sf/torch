...
MPI_PATH   = ${MPIHOME}
HDF4_PATH  =
HDF5_PATH  = /cm/shared/apps/hdf5_18/1.8.11
HYPRE_PATH = 
...
FFLAGS_OPT = -c -O3 -march=westmere -fdefault-real-8 -fdefault-double-8
...
-pedantic -Wall -Waliasing -Wfatal-errors \
...
CFLAGS_OPT = -c -O3 -march=westmere -D_FORTIFY_SOURCE=2
