...
FFLAGS_OPT = -c -O3 -fdefault-real-8 -fdefault-double-8 -march=native
...
-pedantic -Wall -Waliasing -fbacktrace\
-Wsurprising -Wconversion -Wunderflow \
-ffpe-trap=invalid,zero,overflow -fbounds-check \
-fimplicit-none -fstack-protector-all -Wfatal-errors
...
CFLAGS_OPT = -c -O3 -D_FORTIFY_SOURCE=2 -march=native
...
LIB_HDF4  =
LIB_HDF5  = -L ${HDF5_PATH}/lib -Wl,-rpath,${HDF5_PATH}/lib -lhdf5 -lz  #-L ${HDF5_PATH}/lib -lhdf5 -lz
