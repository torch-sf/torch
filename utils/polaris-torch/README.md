...
|--------------|--------------------|----------------------------------------------|-------------|
| `-p`         | `path_snapshot`    | `'/shared_data/vanir/MCF_torch_data/M4/'`    | Path to the Torch snapshot file. |
...
| `-l`         | `line_snapshot`    | `0`                                          | The line in the file containing the list of snapshots to run POLARIS on. |
