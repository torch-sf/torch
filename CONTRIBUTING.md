...
pull request to master from that branch following the
...
* Pull requests should ideally be reviewed and approved by at least one other
  developer.

* Pull requests should describe some test of the modified code.

* If FLASH code or the AMUSE interface to FLASH is modified, it's good to test
  that the AMUSE `flash_worker` builds and works in a simulation run.

* Follow the [AMUSE style guide](https://amusecode.github.io/amuse/reference/style_guide.html)
