...
\begin{figure}[!h]
    \center
    \includegraphics[width=0.9\textwidth]{torch-features.pdf}
    \caption{
...
To install MPI from source, we recommend OpenMPI 4.x (latest stable).
Torch is known to work with OpenMPI 2.x, 3.x, and 4.x.

To install HDF5 from source, we recommend HDF5 1.10.x (latest stable).
Torch is known to work with HDF5 1.8.x and 1.10.x.
...
Load MPI into your environment.  If you have MPI pre-installed on a cluster, do:
\begin{lstlisting}[language=bash]
module load OpenMPI/x.y.z/blah  # for clusters with lmod
\end{lstlisting}

Else, if you built MPI from scratch, set your environment like so:
\begin{lstlisting}[language=bash]
export MPI_HOME={path/to/your/mpi/home}
export MPI_RUN={path/to/your/mpi/run}
...
\begin{figure}
    \center
    \includegraphics[width=0.5\textwidth]{quickstart-dens-slice.pdf}
    \caption{
...
\begin{figure}
    \center
    \includegraphics[width=0.4\textwidth]{quickstart-particles.pdf}
    \caption{
