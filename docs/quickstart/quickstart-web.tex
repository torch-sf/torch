...
Once \texttt{VorAMR} is turned on, install torch \texttt{. ./install.sh}.
...
Uncomment the \texttt{VorAMR} parameters in flash.par. Be sure to re-comment these if you later starting a "normal" Torch run.
