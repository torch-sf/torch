...
ln -s $TORCH_DIR/examples/cube128
cp $TORCH_DIR/torch_user.py                         torch_user.py
cp $TORCH_DIR/examples/flash.par.turbsph_standard   flash.par
mkdir data
\end{lstlisting}
...
As of March 21st 2023, \texttt{VorAMR} exists only on the "vorch" branch of Torch. Do: `git checkout vorch` first to obtain all \texttt{VorAMR} dependencies.
...
For the AMUSE configure step, Brooke uses:
\begin{lstlisting}[language=bash]
./configure --with-fftw=$MODLOC/FFTW/3.3.9-gompi-2021a
--with-hdf5=$MODLOC/HDF5/1.10.7-gompi-2021a/bin/h5c++
--with-gmp=/home/bpolak/TORCH/env/amuse_env
--with-mpfr=/home/bpolak/TORCH/env/amuse_env
--with-gsl-prefix=/home/bpolak/TORCH/env/amuse_env
\end{lstlisting}
In \texttt{amuse/config.mk}, you may need to edit:
\begin{lstlisting}[language=bash]
